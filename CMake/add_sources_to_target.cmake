message(STATUS
        "${MY_STATUS_VARIABLE} Adding sources to the main library target.")
...
target_sources(${MY_LIBRARY_NAME} PRIVATE ${INCLUDE_FILE})
...
target_sources(${MY_LIBRARY_NAME} PRIVATE ${SRC_FILES})
